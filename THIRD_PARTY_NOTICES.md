...
This project uses the third-party software and fonts listed below. Each is the
...
Under the SIL Open Font License, any redistributed or bundled copy of a font
must be accompanied by the copyright notice and the full license text (as a
stand-alone file, a human-readable header, or machine-readable metadata). The
fonts may not be sold on their own and the Reserved Font Names may not be reused
in derivative fonts without permission.
